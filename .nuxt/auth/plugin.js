...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/api/auth/login","method":"post","propertyName":"token"},"logout":{"url":"/api/auth/logout","method":"delete"},"user":{"url":"/api/auth/user","method":"get","propertyName":"user"}},"tokenType":"Bearer","_name":"local"}))
